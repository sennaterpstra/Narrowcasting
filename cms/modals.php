      ...
      <div class="modal-body">
        <form action="rooster_add.php" method="post">
            ...
            <div class="form-group">
                ...
                <input name="tijd" type="text" class="form-control" id="tijd" placeholder="tijd">
            </div>
            <div class="form-group">
                <label for="klas">Klas</label>
                <input name="klas" type="text" class="form-control" id="klas" placeholder="klas">
            </div>
            <div class="form-group">
                <label for="activiteit">Activiteit</label>
                <input name="activiteit" type="text" class="form-control" id="activiteit" placeholder="activiteit">
            </div>
            <div class="form-group">
                <label for="lokaal">Lokaal</label>
                <input name="lokaal" type="text" class="form-control" id="lokaal" placeholder="lokaal">
            </div>
            <div class="form-group">
                <label for="docent">Docent</label>
                <input name="docent" type="text" class="form-control" id="docent" placeholder="docent">
            </div>
            <button name="submit" type="submit" class="btn btn-primary">Toevoegen</button>
        </form>
      </div>
